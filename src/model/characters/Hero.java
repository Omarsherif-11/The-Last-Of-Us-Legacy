...
public abstract class Hero extends Character {
	...
	public String toString() {
		...
		strings.add("Attack Damage : " + getAttackDmg());
		strings.add("Max Health : " + getMaxHp());
		strings.add("Max Actions : " + getMaxActions());
		String res = "";
	...
	public String display() {
		...
		strings.add("Max Health : " + getMaxHp());
		strings.add("Max Actions : " + getMaxActions());
		strings.add("Available Actions : " + getActionsAvailable());
		strings.add("Special Ability : " + (isSpecialAction() ? "On" : "Off"));
		strings.add("Vaccines : " + getVaccineInventory().size());
		strings.add("Supplies : " + getSupplyInventory().size());
		strings.add("Current Health : " + getCurrentHp());
		if(getTarget() != null) {
			strings.add("Target : "+getTarget().getName());
		}
		else {
			strings.add("Target: No Target");
		}
		String res = "";
		for (String s : strings)
			res += s + "\n";
	...
	public void attack() throws NotEnoughActionsException, InvalidTargetException {
		...
		if (this.getTarget() == null)
			throw new InvalidTargetException("Click On A Zombie And then Click Attack.");
		if (!checkDistance())
	...
	public void cure() throws NoAvailableResourcesException, InvalidTargetException, NotEnoughActionsException {
		...
		if (this.getTarget() == null)
			throw new InvalidTargetException("Click On A Zombie Then Click Cure");
		if (!checkDistance())
